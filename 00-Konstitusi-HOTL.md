...
| 2026-08-10 | Dokumen Cadence & Metrik (berkas 06: ritme 10/30/60 HOTL + ritme event-driven spesialis + 4 angka DORA-lite + 2 metrik khas) diajukan | Kerangka pasca-role-mapping | **Diratifikasi (GO)** | PR #6 |
...
| 2026-08-10 | **Ratifikasi G1 PRD-001 (desain v1.3 final) — GO** oleh HOTL setelah lintasan 5 vonis reviewer (2 GAGAL sah → diperbaiki, 1 tak sah/basi, 2 bersyarat → dilunasi); tahap P1 selesai, masuk P2 | Checklist G1 (`01-Checklist-Gerbang.md`) | Sah | PR #4; vonis di `04-G1-Desain-Website-LAZISNU.md` Bagian F |
| 2026-08-10 | **Ratifikasi Rencana Tes QA PRD-001 (v1.1) — GO** oleh HOTL (vonis reviewer: LULUS BERSYARAT, 4 penajaman dilunasi). **Builder ditugaskan: hermes** (atas permintaan HOTL) | Checklist + kartu QA/Builder | Sah | PR #10; berkas 05; `07-Surat-Tugas-Builder-Hermes.md` |
| 2026-08-11 | **Usulan amendemen: cabang khusus Tim Desain** (`spesialis/cabang-desain/` — piagam tim + 3 kartu: web designer, UI designer, UX designer) atas permintaan HOTL; validator diperluas ke 9 kartu; keuntungan: desain berlapis (riset→antarmuka→wajah) dengan jejak pakar per domain; yang dicelakakan: tidak ada — kartu inti tak berubah, segregasi tetap | Pasal 9 + Doktrin Spesialis | **DIRATIFIKASI (GO) oleh HOTL 2026-08-11** | PR #12 |
| 2026-08-11 | **Amendemen protokol: Protokol TONGGAK** — agen WAJIB memperbarui STATUS.md pada setiap pergerakan (commit/PR merged, tes berubah, putusan baru, insiden), bukan hanya di tutup sesi; dicetuskan kritik HOTL "STATUS.md tidak mencatat perkembangan"; pilihan HOTL: ubah protokol saja, tanpa mesin otomatis | Pasal 9 + Protokol TUMBUH | **DIRATIFIKASI (GO) oleh HOTL 2026-08-11** | PR #15 |
| 2026-08-11 | **Ratifikasi revisi tata kelola Tim Desain** — PR #16 (kartu spesialis bergigi standar-rujukan, jawaban PRD-001 §7 no. 6–7, administrasi STATUS.md); dicatat lewat PR tindak lanjut | Pasal 9 + Protokol TUMBUH | **DIRATIFIKASI (GO) oleh HOTL 2026-08-11** | PR #17 |
| 2026-08-12 | **16 putusan paket desain form admin — GO semua** (keberatan spesialis: riset UX 3 + UI 4 + Web 6 + matriks target 3; termasuk: login = biaya keamanan, dialog konfirmasi terbit dipertahankan, tanggal default hari ini, lanjut tanpa logo, profil perangkat asumsi) | Pasal 4 | **DIRATIFIKASI (GO) oleh HOTL 2026-08-12** | PR #18 |
| 2026-08-12 | **GO pencatatan tonggak P0 paket desain** (PR website #12 merged) | Protokol TONGGAK | **DIRATIFIKASI (GO) oleh HOTL 2026-08-12** | PR #19 |
| 2026-08-12 | **GO pencatatan tonggak P1 paket desain** (PR website #13 merged) | Protokol TONGGAK | **DIRATIFIKASI (GO) oleh HOTL 2026-08-12** | PR #20 |
